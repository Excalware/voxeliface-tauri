...
export default function WindowButtons() {
    ...
    return <StyledWindowButtons spacing={24} direction="horizontalReverse" alignItems="center">
		<WindowButtonComponent onClick={close} css={{
			...
			<svg width="16" height="16" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
				<g clip-path="url(#clip0_606_110)">
					<path d="M0.5 0.5L7.5 7.5M7.5 0.5L0.5 7.5" stroke="white" stroke-linecap="round"/>
				</g>
				<defs>
		...
		<WindowButtonComponent onClick={maximize} css={{
			...
			<svg width="16" height="16" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
				<g clip-path="url(#clip0_606_112)">
					<path fill-rule="evenodd" clip-rule="evenodd" d="M0 7V3C0 2.44772 0.447715 2 1 2H5C5.55228 2 6 2.44772 6 3V7C6 7.55228 5.55228 8 5 8H1C0.447715 8 0 7.55228 0 7ZM5 3.5C5 3.22386 4.77614 3 4.5 3H1.5C1.22386 3 1 3.22386 1 3.5V6.5C1 6.77614 1.22386 7 1.5 7H4.5C4.77614 7 5 6.77614 5 6.5V3.5Z" fill="white"/>
		...
		<WindowButtonComponent onClick={minimize} css={{
			...
			<svg width="16" height="16" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path d="M0 4H8" stroke="white" stroke-width="2"/>
			</svg>
		</WindowButtonComponent>
	</StyledWindowButtons>;
}